...
pub const INPUT_PROP_POINTER: u8 = 0x00;   /* needs a pointer */
pub const INPUT_PROP_DIRECT: u8 = 0x01;   /* direct input devices */
pub const INPUT_PROP_BUTTONPAD: u8 = 0x02;   /* has button(s) under pad */
pub const INPUT_PROP_SEMI_MT: u8 = 0x03;   /* touch rectangle only */
pub const INPUT_PROP_TOPBUTTONPAD: u8 = 0x04;   /* softbuttons at top of pad */
pub const INPUT_PROP_POINTING_STICK: u8 = 0x05;   /* is a pointing stick */
pub const INPUT_PROP_ACCELEROMETER: u8 = 0x06;   /* has accelerometer */

pub const INPUT_PROP_MAX: u8 = 0x1f;
pub const INPUT_PROP_CNT: u8 = (INPUT_PROP_MAX + 1);
